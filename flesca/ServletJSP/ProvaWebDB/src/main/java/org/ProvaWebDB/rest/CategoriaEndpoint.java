...
import org.ProvaWebDB.model.Categoria;
...
public class CategoriaEndpoint {
	@PersistenceContext(unitName = "ProvaWebDB-persistence-unit")
	...
	public Response findById(@PathParam("id") long id) {
		TypedQuery<Categoria> findByIdQuery = em
				.createQuery(
						"SELECT DISTINCT c FROM Categoria c LEFT JOIN FETCH c.prodotto WHERE c.id = :entityId ORDER BY c.id",
						Categoria.class);
	...
	public List<Categoria> listAll(@QueryParam("start") Integer startPosition,
		...
		TypedQuery<Categoria> findAllQuery = em
				.createQuery(
						"SELECT DISTINCT c FROM Categoria c LEFT JOIN FETCH c.prodotto ORDER BY c.id",
						Categoria.class);
